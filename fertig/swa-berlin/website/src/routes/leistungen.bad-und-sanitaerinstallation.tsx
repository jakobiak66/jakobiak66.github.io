...
export const Route = createFileRoute("/leistungen/bad-und-sanitaerinstallation")({
  ...
  head: () => ({
    meta: [
      { title: "Bad- und Sanitärinstallation – SWA Service Wartung Anlagenbau Berlin GmbH" },
      {
        name: "description",
        content:
      ...
      {
        property: "og:title",
        content: "Bad- und Sanitärinstallation – SWA Service Wartung Anlagenbau Berlin GmbH",
      },
      {
...
function Page() {
  return (
    <LeistungLayout
      ...
      ctaSubline="Kostenlose Vor-Ort-Beratung in Berlin – persönlich, unverbindlich und vom TGA-Fachbetrieb."
      paragraphs={[
