...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "TGA-Fachbetrieb für Heizung, Sanitär, Lüftung und Kälte-Klima in Berlin und Brandenburg." },
      { name: "author", content: "SWA Berlin GmbH" },
      { property: "og:title", content: "SWA Service Wartung Anlagenbau Berlin GmbH" },
      { property: "og:description", content: "Professionelle TGA-Dienstleistungen in Berlin und Brandenburg." },
