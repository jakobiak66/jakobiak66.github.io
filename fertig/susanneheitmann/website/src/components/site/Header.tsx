      ...
      <div className="bg-primary-dark text-primary-foreground text-xs">
        <div className="container flex h-9 items-center justify-between gap-4 text-primary-foreground">
          <div className="hidden sm:flex items-center gap-5 opacity-90">
            <span className="flex items-center gap-1.5"><MapPin className="h-3.5 w-3.5" /> Berlin & Osnabrück</span>
            <span className="flex items-center gap-1.5"><ShieldCheck className="h-3.5 w-3.5" /> Freischaffende Künstlerin</span>
          </div>
          <div className="sm:hidden flex items-center gap-1.5 font-medium">Malerei · Siebdruck · Collage</div>
          <a href="#kontakt" className="font-semibold hover:opacity-80 transition-opacity inline-flex items-center gap-1.5">
            Kontakt
          </a>
        </div>
      </div>
        ...
        <div className="container flex h-20 items-center justify-between gap-6">
          <a href="/" className="flex items-center gap-3 group">
            ...
            <div className="leading-tight">
              <div className="font-extrabold text-lg text-foreground tracking-tight">Susanne Heitmann</div>
              <div className="text-xs text-muted-foreground">Bildende Künstlerin · Osnabrück / Berlin</div>
            </div>
          </a>
