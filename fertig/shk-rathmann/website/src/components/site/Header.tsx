    ...
    <header className="sticky top-0 z-50">
      ...
      <div className="bg-primary-dark text-primary-foreground text-xs">
        <div className="container flex flex-wrap items-center justify-center gap-x-6 gap-y-1 py-2 text-center">
          <span className="opacity-90">⚡ Notruf-Service · Werktags ab 16 Uhr, Wochenende 24 Stunden</span>
          <a href="tel:01774916308" className="hidden md:inline-flex items-center gap-1 hover:text-primary-glow transition-smooth">
            <Phone className="h-3 w-3" /> 0177 491 63 08 (Notruf)
          </a>
        </div>
      </div>
