...
export const About = () => (
  <section className="py-16 border-b border-border bg-background">
    <div className="container grid md:grid-cols-2 gap-10 items-center">
      <img src="/fat-daddys-tattoo/images/tattoo-artist.jpg" alt="Bernd Lindner â€“ Ihr Ansprechpartner" loading="lazy" width={1024} height={768} className="rounded-2xl shadow-card object-cover w-full" />
      <div>
