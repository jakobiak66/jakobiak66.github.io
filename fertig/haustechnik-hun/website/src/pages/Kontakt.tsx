        ...
        <section id="kontakt" className="container py-20">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground max-w-3xl mx-auto">
              Haben Sie Fragen zu Heizung, Sanitär oder Solar? Kontaktieren Sie uns – wir beraten Sie kompetent und sind auch außerhalb der regulären Öffnungszeiten für Notfälle erreichbar.
            </p>
          </div>
            ...
            <div className="flex flex-col">
              <div className="rounded-2xl overflow-hidden bg-card shadow-card">
                ...
                <div className="p-6 space-y-4">
                  <div>
                    <div className="font-bold text-primary-dark text-lg">Laszlo Hun</div>
                    <div className="text-sm text-muted-foreground">Installateur- und Heizungsbaumeister</div>
                  </div>
                  <div className="border-t border-border pt-4 space-y-3 text-sm">
                    <a href="tel:+4975519450480" className="flex items-center gap-3 text-foreground hover:text-primary transition-smooth">
                      <span className="h-8 w-8 rounded-full bg-secondary flex items-center justify-center">
                        <Phone className="h-4 w-4 text-primary" />
                      </span>
                      +49 7551 / 945048
                    </a>
                    <a href="mailto:info@haustechnik-hun.de" className="flex items-center gap-3 text-foreground hover:text-primary transition-smooth">
                      <span className="h-8 w-8 rounded-full bg-secondary flex items-center justify-center">
                        <Mail className="h-4 w-4 text-primary" />
                      </span>
                      info@haustechnik-hun.de
                    </a>
                    <div className="flex items-center gap-3 text-foreground">
                      <span className="h-8 w-8 rounded-full bg-secondary flex items-center justify-center">
                        <MapPin className="h-4 w-4 text-primary" />
                      </span>
                      Heiligenbreite 22, 88662 Überlingen
                    </div>
                  </div>
                </div>
              </div>
