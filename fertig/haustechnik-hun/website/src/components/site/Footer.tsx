      ...
      <div className="container py-14 grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm opacity-80">
            <li className="flex items-start gap-2"><Phone className="h-4 w-4 mt-0.5 text-primary-glow" /> +49 7551 / 945048</li>
            <li className="flex items-start gap-2"><Mail className="h-4 w-4 mt-0.5 text-primary-glow" /> info@haustechnik-hun.de</li>
            <li className="flex items-start gap-2"><MapPin className="h-4 w-4 mt-0.5 text-primary-glow" /> Heiligenbreite 22, 88662 Überlingen</li>
          </ul>
        </div>
      </div>
