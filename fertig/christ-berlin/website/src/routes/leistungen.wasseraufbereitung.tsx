...
export const Route = createFileRoute("/leistungen/wasseraufbereitung")({
  ...
  head: () => ({
    meta: [
      { title: "Wasseraufbereitung – Dipl.-Ing. Alexander Christ GmbH" },
      {
        name: "description",
        content:
          "Reines Wasser für Ihr Zuhause – Beratung und physikalische Wasseraufbereitung vom Fachbetrieb in Berlin.",
      },
      { property: "og:title", content: "Wasseraufbereitung – Dipl.-Ing. Alexander Christ GmbH" },
      {
