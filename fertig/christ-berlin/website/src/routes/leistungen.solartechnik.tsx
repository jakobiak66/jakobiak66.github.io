...
export const Route = createFileRoute("/leistungen/solartechnik")({
  head: () => ({
    meta: [
      { title: "Solartechnik – Dipl.-Ing. Alexander Christ GmbH" },
      {
        name: "description",
        content:
          "Emissionsschonend und wirtschaftlich heizen – Planung und Umsetzung von thermischen Solaranlagen und Photovoltaik.",
      },
      { property: "og:title", content: "Solartechnik – Dipl.-Ing. Alexander Christ GmbH" },
      {
        property: "og:description",
        content: "Emissionsschonend & wirtschaftlich – Solartechnik vom Fachbetrieb Christ.",
      },
    ],
  }),
