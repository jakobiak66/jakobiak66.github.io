...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ihr Fachbetrieb für Heizung, Sanitär, Schornsteinbau und Solar in Berlin. 24h-Notdienst." },
      { name: "author", content: "Alexander Christ GmbH" },
      { property: "og:title", content: "Dipl.-Ing. Alexander Christ GmbH" },
      { property: "og:description", content: "Gebäudetechnik in Berlin – Heizung, Sanitär, Solar und Schornsteinbau." },
