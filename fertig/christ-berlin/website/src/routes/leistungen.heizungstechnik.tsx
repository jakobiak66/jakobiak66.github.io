...
export const Route = createFileRoute("/leistungen/heizungstechnik")({
  ...
  head: () => ({
    meta: [
      { title: "Heizungstechnik – Dipl.-Ing. Alexander Christ GmbH" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Heizungstechnik – Dipl.-Ing. Alexander Christ GmbH" },
      {
        property: "og:description",
        content: "Energiesparende Wohlfühlräume – Heizungstechnik vom Fachbetrieb Christ.",
      },
    ],
  }),
});
