...
export const Route = createFileRoute("/leistungen/wohnraumlueftung")({
  ...
  head: () => ({
    meta: [
      { title: "Wohnraumlüftung – Dipl.-Ing. Alexander Christ GmbH" },
      {
        name: "description",
        content:
          "Frische Luft ohne Wärmeverlust – kontrollierte Wohnraumlüftung mit Wärme- und Feuchterückgewinnung.",
      },
      { property: "og:title", content: "Wohnraumlüftung – Dipl.-Ing. Alexander Christ GmbH" },
      {
...
function Page() {
  return (
    <LeistungLayout
      ...
      ctaSubline="Kostenlose Beratung zur kontrollierten Wohnraumlüftung – persönlich vor Ort in Berlin."
      paragraphs={[
